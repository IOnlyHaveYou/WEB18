	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${productList }" var="product">
			<div class="col-md-2" style="height:250px">
				<a href="productInfo?productid=${product.pid }"> 
					<img src="${pageContext.request.contextPath }/${product.pimage }" name="img" width="170" height="170" style="display: inline-block;">
				</a>
				<p>
					<a href="productInfo?productid=${product.pid }"  style='color: green'>${product.pname }</a>
				</p>
				<p>
